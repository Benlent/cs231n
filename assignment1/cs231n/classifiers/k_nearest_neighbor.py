...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    #########################################################################
    # test_sum = np.sum(np.power(X, 2), axis = 1)
    ...
    # print('test_sum:', test_sum.shape)
    # print('train_sum:', train_sum.shape)
    # print('dot:', dot.shape)
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      sort_indice = np.argsort(dists[i, :])[:k]
      closest_y = [self.y_train[index] for index in sort_indice]
      #########################################################################
      # TODO:                                                                 #
